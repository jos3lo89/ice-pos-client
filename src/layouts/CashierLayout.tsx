...
const CashierLayout = () => {
  ...
  const session = sessionData?.hasActiveSession ? sessionData.session : null;
  ...
  return (
    <div className="h-screen w-full bg-[#0f172a] flex text-slate-100 font-sans overflow-hidden">
        ...
        <div className="p-4 border-t border-slate-700/50 flex flex-col gap-4">
          ...
          {!sidebarCollapsed || sidebarOpen ? (
            <button
              ...
              className="flex items-center gap-3 p-2 rounded-xl bg-slate-800/50 border border-slate-700/50 hover:bg-slate-700/50 hover:border-emerald-500/30 transition-all group w-full text-left"
            >
              <div className="w-9 h-9 rounded-full bg-linear-to-br from-slate-600 to-slate-700 flex items-center justify-center text-white font-bold text-sm shadow-inner shrink-0 group-hover:ring-2 ring-emerald-500/50 transition-all">
            ...
            >
              <div className="w-9 h-9 rounded-full bg-linear-to-br from-slate-600 to-slate-700 flex items-center justify-center text-white font-bold text-sm shadow-inner hover:ring-2 ring-emerald-500/50 transition-all">
                {user.nombre_completo.charAt(0)}
              </div>
            </button>
          )}
      ...
      <main className="flex-1 flex flex-col relative overflow-hidden bg-[#0f172a]">
        {/* Cashier Specific Header - Always Static and Visible */}
        <header className="h-24 lg:h-20 bg-[#1e293b]/70 backdrop-blur-xl border-b border-slate-700/50 flex items-center px-4 lg:px-8 justify-between shrink-0 z-30 shadow-lg">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                />
                <h2 className="text-sm lg:text-base font-bold text-white truncate max-w-[120px] lg:max-w-none">
          ...
          <div className="flex items-center gap-2 lg:gap-6 overflow-x-auto no-scrollbar py-2">
            {!isSessionLoading && session && (
              <>
                {/* Resumen Rápidol */}
                <div className="flex items-center gap-3 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-lg shrink-0">
                  <Wallet className="w-4 h-4 text-emerald-400" />
                  <div className="flex flex-col">
                    <span className="text-[9px] text-emerald-500/70 font-bold uppercase leading-tight">
                      Efectivo
                    </span>
                ...
                <div className="flex items-center gap-3 px-3 py-1.5 bg-blue-500/10 border border-blue-500/20 rounded-lg shrink-0">
                  <Smartphone className="w-4 h-4 text-blue-400" />
                  <div className="flex flex-col">
                    <span className="text-[9px] text-blue-500/70 font-bold uppercase leading-tight">
                      Digital
                    </span>
                ...
                <div className="flex items-center gap-3 px-4 py-1.5 bg-linear-to-r from-cyan-600 to-blue-600 rounded-lg shrink-0 shadow-md shadow-cyan-900/20">
                  <TrendingUp className="w-4 h-4 text-white" />
                  <div className="flex flex-col">
                    <span className="text-[9px] text-white/70 font-bold uppercase leading-tight">
                      Total
                    </span>
            ...
            {/* User Icon & Date only on desktop or if space permits */}
            <div className="hidden xl:flex items-center gap-4 border-l border-slate-700/50 pl-6 ml-2">
        ...
        {/* Top Gradient Line */}
        <div className="h-[2px] w-full bg-linear-to-r from-emerald-500/50 via-teal-600/50 to-transparent shrink-0" />

        {/* View Port */}
        <div className="flex-1 overflow-y-auto scroll-smooth relative p-4">
